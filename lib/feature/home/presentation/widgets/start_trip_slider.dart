...
class StartTripSlider extends StatefulWidget {
  final VoidCallback onStartTrip;

  const StartTripSlider({super.key, required this.onStartTrip});

  @override
  State<StartTripSlider> createState() => _StartTripSliderState();
}

class _StartTripSliderState extends State<StartTripSlider>
    ...
    return SizedBox(
      ...
      child: LayoutBuilder(
        builder: (context, constraints) {
          ...
          // Color transitions from primaryColor → online as user drags
