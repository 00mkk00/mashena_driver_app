...
mixin _$CompleteTripEntity {
  ...
  double? get originalFare => throw _privateConstructorUsedError;
...
class _$CompleteTripEntityImpl implements _CompleteTripEntity {
  const _$CompleteTripEntityImpl({
    this.tripId,
    this.status,
    this.completedAt,
    this.distanceKm,
  ...
  @override
  String toString() {
    return 'CompleteTripEntity(tripId: $tripId, status: $status, completedAt: $completedAt, distanceKm: $distanceKm, durationSec: $durationSec, originalFare: $originalFare, discountAmount: $discountAmount, finalFare: $finalFare, fareTotal: $fareTotal, appliedCoupon: $appliedCoupon, platformCommission: $platformCommission)';
  }
...
abstract class _CompleteTripEntity implements CompleteTripEntity {
  const factory _CompleteTripEntity({
    final int? tripId,
    final String? status,
    final String? completedAt,
    final double? distanceKm,
