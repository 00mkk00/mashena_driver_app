...
mixin _$TripModel {
  ...
  List<String> get stops =>
      throw _privateConstructorUsedError; // nullable — backend returns {} for these
...
abstract class _TripModel implements TripModel {
  ...
  @override
  List<String> get stops; // nullable — backend returns {} for these
  @override
