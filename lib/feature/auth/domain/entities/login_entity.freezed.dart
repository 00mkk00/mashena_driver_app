...
mixin _$LoginEntity {
  ...
  DriverEntity get user => throw _privateConstructorUsedError;
...
abstract class $LoginEntityCopyWith<$Res> {
  ...
  @useResult
  $Res call({String accessToken, DriverEntity user});

  $DriverEntityCopyWith<$Res> get user;
}
...
class _$LoginEntityCopyWithImpl<$Res, $Val extends LoginEntity>
  ...
  @pragma('vm:prefer-inline')
  $DriverEntityCopyWith<$Res> get user {
    return $DriverEntityCopyWith<$Res>(_value.user, (value) {
...
class _$LoginEntityImpl implements _LoginEntity {
  const _$LoginEntityImpl({required this.accessToken, required this.user});
...
abstract class _LoginEntity implements LoginEntity {
  const factory _LoginEntity({
    ...
    required final DriverEntity user,
  }) = _$LoginEntityImpl;

  @override
  String get accessToken;
  @override
  DriverEntity get user;
